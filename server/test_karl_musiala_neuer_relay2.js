 ...
 * 用法: node test_karl_musiala_neuer_relay2.js
 */
...
const OUTPUT_DIR = path.resolve(__dirname, '..', '生成测试', 'karl_musiala_neuer_relay2');
...
async function main() {
  ...
  console.log(D);
  console.log('  参考图顺序:');
  console.log('    Image 1  用户照片 9dc96094...');
  console.log('    Image 2  用户照片 322dc610...');
